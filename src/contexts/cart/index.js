...
const CART_ACTION_TYPES = {
  ...
  SET_IS_CART_ITEMS: "SET_CART_ITEMS",
  SET_IS_CART_COUNT: "SET_CART_COUNT",
  SET_IS_CART_TOTAL: "SET_CART_TOTAL"
}
...
export const CartProvider = ({children}) => {
  ...
  const updateCartItemsReducer = (cartItems) => {
    ...
    dispatch(createAction(CART_ACTION_TYPES.SET_IS_CART_ITEMS, payload))
  }
